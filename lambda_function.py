...
def recommend_portfolio(intent_request):
    ...
    ageUser = get_slots(intent_request)["age"]
    ...
    if ageUser is not None:
        ageUser = parse_int(
            ageUser
        )#Have to parse ageUser because it's a string originally
    if ageUser < 1 or ageUser > 65:
        return build_validation_result(
            False,
            "age",
            "You shouldn't be older than 65 or younger than 1 to use this service, "
            "please bring an adult that isn't retired or an infant.",
        )
    ...
    if investment_amount < 5000:
        return build_validation_result(
            ...
            "please provide a proper amount to invest.",
        )
...
def dispatch(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            with your risk level of {} your portfolio will have the following breakdown: {}.
            """.format(
