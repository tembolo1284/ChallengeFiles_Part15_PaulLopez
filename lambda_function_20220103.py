...
def validate_data(age, investment_amount, intent_request):
    ...
    # Validate that the user is over 0 years old and less than 65
    if age is not None:
        age = parse_int(
            age
        )
        if age < 1 or age > 65:
            return build_validation_result(
                False,
                "age",
                "You are not the right age to use this application. Please be younger than 65 and older than 0. "
    ...
    if investment_amount is not None:
        ...
        if investment_amount > 5000:
            return build_validation_result(
                ...
                "please provide a correct amount in dollars to use for investment.",
            )
